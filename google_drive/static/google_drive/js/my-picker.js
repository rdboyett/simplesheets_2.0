...
$('#fileTabs a').click(function (e) {
  ...
  $(this).tab('show');
    ...
    $('#upload-pdf-form').ajaxForm({
	beforeSubmit: function(){
	    $('#upload-pdf-modal').modal('hide');
	    $('#shade').fadeIn(600);
	    $('#login-page').fadeIn(600);
	},
    ...
    $(".docListBtn").click(function(){
	if (!$("#docListView").is(':visible')) {
	    $("#docGridView").fadeOut(300,function(){
		$("#docListView").fadeIn(300);
	    });
	}
	if (!$("#pdfListView").is(':visible')) {
	    $("#pdfGridView").fadeOut(300,function(){
		$("#pdfListView").fadeIn(300);
	    });
	}
    });
    
    $(".docGridBtn").click(function(){
	if (!$("#docGridView").is(':visible')) {
	    $("#docListView").fadeOut(300,function(){
		$("#docGridView").fadeIn(300);
	    });
	}
	if (!$("#pdfGridView").is(':visible')) {
	    $("#pdfListView").fadeOut(300,function(){
		$("#pdfGridView").fadeIn(300);
	    });
	}
    });


    $(".item-holder").click(function(){
	var fileID = $(this).data('fileid');
	$(".item-holder .fileName").removeClass('active');
	$(this).find('.fileName').addClass('active');
	$("#googleFileID").val(fileID);
    });



    $(".item-holder").dblclick(function(){
	var fileID = $(this).data('fileid');
	checkProjectExists(fileID);
    });
